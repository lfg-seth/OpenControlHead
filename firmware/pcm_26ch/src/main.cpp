...
#define PASS_REV (1UL << 0)   // Channel 1
#define PASS_BRAKE (1UL << 1) // Channel 2

#define PASS_TURN (1UL << 3)    // Channel 4
#define DRIVE_REV (1UL << 4)    // Channel 5
#define DRIVE_BRAKE (1UL << 5)  // Channel 6
#define DRIVE_TURN (1UL << 6)   // Channel 7
#define CARGO_LIGHTS (1UL << 7) // Channel 8
#define ROCK_LIGHTS (1UL << 8)  // Channel 9

#define CHASE_AMBER (1UL << 10) // Channel 11
#define CHASE_WHITE (1UL << 11) // Channel 12
...
void setup()
{
  ...
  flashingPatterns[33] = {
      {{DRIVE_TURN | CHASE_AMBER, 50},
       {EMPTY, 50},
       {DRIVE_TURN | CHASE_WHITE, 50},
       {EMPTY, 200},
       {PASS_TURN | CHASE_AMBER, 50},
       {EMPTY, 50},
       {PASS_TURN | CHASE_WHITE, 50},
       {EMPTY, 200}},
      8,
      0,
      false,
  ...
  flashingPatterns[34] = {
      {{DRIVE_TURN | PASS_REV, 500},
       {PASS_TURN | DRIVE_REV, 500}},
      2,
      0,
      false,
      false,
